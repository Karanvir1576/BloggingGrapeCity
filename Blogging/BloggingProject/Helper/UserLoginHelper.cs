...
namespace BloggingProject.Helper
{
    public class UserLoginHelper
    {
        ...
        public string GetAuthToken(UserLogin userLogin)
        {
            ...
            var securityToken = new JwtSecurityToken(_configuration["Jwt:Issuer"], null, null, null,DateTime.Now.AddHours(2.0), new SigningCredentials(signingKey, SecurityAlgorithms.HmacSha256));
