...
//                optionsBuilder.UseSqlServer("Data Source=192.168.0.118;Initial Catalog=Test20;Persist Security Info=True;User ID=sa;Password=sa@12345678");
//            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Blog>(entity =>
            {
                ...
                entity.Property(e => e.DttmRcdAdded)
                    .HasMaxLength(14)
                    .IsUnicode(false)
                    .HasColumnName("DTTM_RCD_ADDED");

                entity.Property(e => e.DttmRcdUpdated)
                    .HasMaxLength(14)
                    .IsUnicode(false)
                    .HasColumnName("DTTM_RCD_UPDATED");
            });
